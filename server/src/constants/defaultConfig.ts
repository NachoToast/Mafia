...
export const defaultConfig: Omit<Config, 'mongoURI'> = {
    ...
    /**
     * This ensures cryptographic security,
     * but also means it will change every time the server restarts,
     * meaning user sessions will not persist between server restarts either.
     *
     * This default is undocumented in the schema
